...
展开可得
```math
P(a_{i,t}) = \alpha_i^t \cdot P(a_{i,0} + P^{cri}_i \cdot (1 + \alpha + \alpha^2 + \dots + \alpha^{t-1})
```

求极限可得
<img width="331" height="57" alt="图片" src="https://github.com/user-attachments/assets/ce3d1d4e-ee8c-473d-8324-51e9d460da1e" />
<img width="197" height="37" alt="图片" src="https://github.com/user-attachments/assets/e3b1640c-8ab9-49b7-abde-f729e668de75" />
